...
- **ABI y Dirección:** Se generan tras la migración y se gestionan a través del servicio web3 del frontend.
...
- **Ubicación del Código Fuente:** Dentro de la carpeta `src/app/` del proyecto.
...
- **Smart Contract:**
   - Pruebas unitarias con Truffle (JavaScript/Mocha/Chai).
...
├── node_modules/                 # Dependencias del proyecto (excluido por .gitignore)
